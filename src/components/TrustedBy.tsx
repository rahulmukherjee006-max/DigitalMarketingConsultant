...
const clients = [
  { 
    name: 'Apex Builders', 
    logo: (
      <svg className="w-full h-full text-text-muted group-hover:text-text-main transition-colors" viewBox="0 0 200 50" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function TrustedBy() {
  return (
    <section className="py-16 px-6 bg-bg-primary border-y border-border-subtle relative z-10">
