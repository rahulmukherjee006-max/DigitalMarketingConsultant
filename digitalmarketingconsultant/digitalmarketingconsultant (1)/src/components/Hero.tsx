      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          <div className="bg-brand-accent/10 border border-brand-accent/30 rounded-2xl p-4 flex flex-col sm:flex-row items-center sm:items-start gap-4 text-left relative overflow-hidden group hover:border-brand-accent/60 transition-colors">
            ...
            <div className="w-12 h-12 shrink-0 bg-[#0c1205] border border-brand-accent/20 rounded-full flex items-center justify-center shadow-lg">
               <Star className="w-6 h-6 text-brand-accent" />
            </div>
            <div>
              <h3 className="font-bold text-white text-lg flex flex-wrap items-center gap-2">
                Starting a business? 
                <span className="bg-brand-accent text-[#0c1205] px-2 py-0.5 rounded font-black text-sm uppercase tracking-wide">30% OFF</span>
              </h3>
              <p className="text-[#d6dae1] text-sm mt-1">
                Women entrepreneurs get an exclusive <strong>30% discount</strong> on all services, plans, and add-ons.
              </p>
              <p className="text-[#8997a7] text-xs mt-2 font-mono">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#24272d] border border-white/10 text-xs font-semibold text-white mb-8"
        >
        ...
        <motion.h1 
          ...
          className="text-5xl md:text-7xl lg:text-8xl font-bold leading-[0.9] mb-8 text-white"
        >
        ...
        <motion.p
          ...
          className="max-w-2xl mx-auto text-lg text-[#d6dae1] mb-12"
        >
        ...
        >
          <a
            href="#contact"
            className="w-full sm:w-auto bg-brand-accent text-brand-dark px-8 py-5 rounded-full font-bold text-lg flex items-center justify-center gap-3 hover:opacity-90 transition-all shadow-xl shadow-brand-accent/20"
          >
            Start Your Growth Journey
            <ArrowRight className="w-5 h-5" />
          </a>
          <button className="w-full sm:w-auto group flex items-center justify-center gap-3 px-8 py-5 rounded-full font-bold text-lg text-white hover:bg-white/5 transition-all">
            <div className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center group-hover:scale-110 transition-transform bg-[#24272d]">
        ...
        >
          <div className="relative z-10 rounded-[40px] border-8 border-white/10 overflow-hidden shadow-2xl">
            <img 
